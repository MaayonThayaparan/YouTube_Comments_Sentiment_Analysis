...
export type ReplyItem = { id: string; textOriginal: string; likeCount: number; authorDisplayName: string; authorChannelId?:string|null; authorCountry?:string|null; authorSubscriberCount?:number|null; publishedAt: string; base?: number }
export type ThreadItem = { id: string; textOriginal: string; likeCount: number; authorDisplayName: string; authorChannelId?:string|null; authorCountry?:string|null; authorSubscriberCount?:number|null; publishedAt: string; totalReplyCount: number; replies: ReplyItem[]; base?: number }
